...
(function (window, document) {
  ...
  var STORAGE_PREFIX = "kt-table-col-width:";
  ...
  function initTable(table) {
    if (!table || table.getAttribute("data-kt-resize-init") === "1") return;
    ...
    var pageId =
      table.getAttribute("data-kt-resize-id") ||
    ...
    visibleThs.forEach(function (th, index) {
      ...
      if (th.querySelector(".kt-col-resize-handle")) return;

      var handle = document.createElement("button");
      handle.type = "button";
      handle.className = "kt-col-resize-handle";
    ...
    table.classList.add("kt-resizable-table", "kt-cols-ready");
    table.setAttribute("data-kt-resize-init", "1");
  ...
  function startDrag(ev, table, th, pageId) {
    ...
    document.documentElement.classList.add("kt-col-resizing");
    ...
    function onUp(e) {
      document.documentElement.classList.remove("kt-col-resizing");
  ...
  function initAll(root) {
    ...
    var tables = scope.querySelectorAll(
      "[data-kt-page-id=\"prominent-figures\"] .encyclopedia-table[data-kt-resizable-table]"
    );
