/**
 * Knowledge Treasury — floating back-to-top control for long pages.
 */
(function (global) {
  "use strict";
  ...
  function getScrollY() {
    if (global.KT_SCROLL_LOCK && typeof global.KT_SCROLL_LOCK.getScrollY === "function") {
      return global.KT_SCROLL_LOCK.getScrollY();
    }
  ...
  function isScrollLocked() {
    ...
    var body = document.body;
    return (
      (global.KT_SCROLL_LOCK && global.KT_SCROLL_LOCK.isLocked && global.KT_SCROLL_LOCK.isLocked()) ||
      (root && root.classList.contains("kt-scroll-lock")) ||
      (body && body.classList.contains("kt-scroll-lock"))
    );
  }
  ...
  function createButton() {
    ...
    btn.type = "button";
    btn.className = "kt-back-to-top";
    btn.id = "kt-back-to-top";
    btn.setAttribute("aria-label", labels.label);
    btn.setAttribute("title", labels.label);
    btn.setAttribute("aria-hidden", "true");
    btn.tabIndex = -1;
    btn.innerHTML =
      '<svg class="kt-back-to-top__icon" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true" focusable="false">' +
  ...
  function init() {
    ...
    var uiPromise =
      global.KT_I18N && global.KT_I18N.loadUi ? global.KT_I18N.loadUi() : Promise.resolve(null);
