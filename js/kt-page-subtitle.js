...
(function (global) {
  ...
  function assetRoot() {
    ...
    var explicit = document.documentElement.getAttribute("data-kt-asset-root");
  ...
  function pageId() {
    var attr = document.documentElement.getAttribute("data-kt-page-id");
    if (attr) return attr;
    var I18N = global.KT_I18N;
  ...
  global.KT_PAGE_SUBTITLE = { init: init };
